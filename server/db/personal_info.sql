...
CREATE TABLE `menu`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `parent_id` int NULL DEFAULT NULL COMMENT '父菜单ID，一级菜单为0',
...
CREATE TABLE `organization`  (
  ...
  `organization_type_id` int NULL DEFAULT NULL COMMENT '机构类型ID',
...
CREATE TABLE `organization_product`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `organization_id` int NULL DEFAULT NULL COMMENT '机构ID',
  `product_id` int NULL DEFAULT NULL COMMENT '产品ID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '机构产品' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `organization_type`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '机构类型' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `role`  (
  ...
  `organization_id` int NULL DEFAULT NULL COMMENT '所属机构ID',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `role_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色菜单' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `up_block`  (
  ...
  `real_id` int UNSIGNED NULL DEFAULT NULL,
...
CREATE TABLE `user`  (
  ...
  `organization_id` int NULL DEFAULT NULL COMMENT '所属机构',
  `status` int NULL DEFAULT NULL COMMENT '状态',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
